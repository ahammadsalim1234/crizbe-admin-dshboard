...
function ProfileModal({ isOpen }: props) {
    return (
        <>
            {
                isOpen && (
                    <div className='absolute top-[10px] right-0 bg-[#1e1e1e] border border-gray-700 shadow-2xl w-[280px] rounded-[24px] overflow-hidden transition-all duration-300 ease-in-out'>
                        {/* User Header Section */}
